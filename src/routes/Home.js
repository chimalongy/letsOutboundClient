...
function Home() {
  ...
  return (
    <div>
      <section id="hero" className='section-dark section'>
        ...
        <div className='section-container section1'>
          ...
          <div className='section1-left'>
            ...
            <button className='site-button'data-aos="fade-up" data-aos-duration='2500' onClick={()=>{
                navmove("/register")
            }}>Get Started</button>
          </div>
      ...
      <section id="feautres" className='section-light section'>
        <div className='section-container'>
          <h1 className='section-header'data-aos="zoom-in"data-aos-duration='1000'>Feautures</h1>

          <div className='feautures-container'>

            <FeaturesLeft image={emailint} heading={"Seamless Gmail Integration"} description={"Effortlessly schedule and send emails directly from your Gmail account."} data-aos="slide-right"data-aos-duration='1000'/>
            <FeaturesRight image={userInterface} heading={"Intuitive User Interface"} description={"Our easy-to-use platform ensures you'll be scheduling emails like a pro in no time."}data-aos="slide-left"data-aos-duration='1000' />
            <FeaturesLeft image={precision} heading={"Precision and Accuracy"} description={"Reliable scheduling ensures your emails reach the right recipients at the perfect time."} data-aos="slide-right"data-aos-duration='1000'/>
            <FeaturesRight image={responsive} heading={"Accessible Anywhere"} description={"Access your scheduled emails on any device, wherever you are."} data-aos="slide-left"data-aos-duration='1000' />
      ...
      <section id="HIW" className='section-dark section'>
        <div className='section-container'>
      ...
      <section id='FAQ' className='section-light section'>
        <div class="section-container" >
          ...
          <details data-aos="fade-up"data-aos-duration='500'>
            <summary>WHAT IS LETSOUTBOUND<i class="fa-solid fa-chevron-right"></i></summary>
            <p>Let's outbound is an easy to use platform for scheduling and performing you email outbound tasks</p>
          </details>

          <details data-aos="fade-up"data-aos-duration='700'>
            <summary>HOW MANY GMAIL ACCONTS CAN I ADD <i class="fa-solid fa-chevron-right"></i></summary>
          ...
          <details data-aos="fade-up"data-aos-duration='900'>
            <summary>DOES MY EMAILS LAND IN THE INBOX? <i class="fa-solid fa-chevron-right"></i></summary>
          ...
          <details data-aos="fade-up"data-aos-duration='1200'>
            <summary>CAN I SEND FROM A CUSTOM EMAIL LINKED WITH GMAIL <i class="fa-solid fa-chevron-right"></i></summary>
